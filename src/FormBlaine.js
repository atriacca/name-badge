...
export default function Form(props) {
       ...
       return (
           <form name="inputs" style={styles.form} onSubmit = {(e) => {props.handleSubmit(e, props)}}>
               <div>
               <input style={styles.input} value={ props.fName } name="fName" onChange={props.handleChange} placeholder="First Name"></input>
               <input style={styles.input} value={ props.lName } name="lName" onChange={props.handleChange} placeholder="Last Name"></input>
               </div>
               <div>
               <input style={styles.input} value={ props.email } name="email" onChange={props.handleChange} placeholder="Email"></input>
               <input style={styles.input} value={ props.birth } name="birth" onChange={props.handleChange} placeholder="Place of Birth"></input>
               </div>
               <div>
               <input style={styles.input} value={ props.phone } name="phone" onChange={props.handleChange} placeholder="Phone"></input>
